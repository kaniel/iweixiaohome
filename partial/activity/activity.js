angular.module('iwx').controller('ActivityCtrl', function ($scope, $http, $state, ngTableParams, $rootScope, eventType, $modal) {
    ...
    $scope.confirmModal = function(){
        ...
        } else if($scope.confirm.type === 'unpublish' || $scope.confirm.type === 'publish'){
